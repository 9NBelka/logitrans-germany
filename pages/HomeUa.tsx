      ...
      <div className='relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden'>
        ...
        <div className='relative z-10 text-center px-4 max-w-4xl mx-auto mt-16'>
          ...
          <p className='text-xl text-gray-200 mb-10 max-w-2xl mx-auto font-light'>
            Спеціалізуємося на перевезеннях від 3,5 до 20 тонн. Ми оптимізуємо ваш ланцюг постачання
        ...
        <div className='grid md:grid-cols-2 gap-12 items-center'>
          <div>
            ...
            <p className='text-lg text-gray-600 mb-8 leading-relaxed'>
              ...
              грошей. Саме тому ми використовуємо сучасну телематику, підготовлений персонал і пряму
              комунікацію.
            </p>
        ...
        <div className='grid md:grid-cols-3 gap-10'>
          <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-gray-300'>
              Жодних прихованих витрат. Ми відкрито та проактивно інформуємо на кожному етапі.
            </p>
          </div>
          <div className='flex flex-col items-center text-center'>
            <div className='bg-white/10 p-6 rounded-full mb-6 backdrop-blur-sm'>
      ...
      <Section id='logistics'>
        <div className='flex flex-col lg:flex-row gap-16'>
          <div className='lg:w-1/2'>
            ...
            <h3 className='text-4xl font-extrabold text-navy-900 mb-6'>
              Зосередьтесь на своєму ключовому бізнесі.
            </h3>
            <p className='text-lg text-gray-600 mb-8'>
              Складське зберігання, комплектація та управління перевезеннями потребують значних
              ресурсів. Ми беремо на себе всю вашу логістику — ефективніше та часто вигідніше, ніж
              внутрішні рішення.
            </p>

            <ul className='space-y-4 mb-8'>
              {[
                'Відсутність постійних витрат на власний автопарк і персонал',
                'Масштабовані рішення для сезонних коливань',
                'Професійне управління складом і обліком запасів',
                'Безшовна IT-інтеграція',
              ].map((item, i) => (
          ...
          <div className='lg:w-1/2'>
            <h4 className='text-2xl font-bold text-navy-900 mb-8'>Наш процес</h4>
            <div className='space-y-8 relative'>
              ...
              {[
                {
                  title: 'Аналіз',
                  desc: 'Ми аналізуємо ваші поточні процеси та структуру витрат.',
                },
                { title: 'Концепція', desc: 'Розробка індивідуальної стратегії аутсорсингу.' },
                { title: 'Організація', desc: 'Передача логістичних процесів і впровадження.' },
                { title: 'Результат', desc: 'Постійна оптимізація та звітність.' },
              ].map((step, idx) => (
