...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-slate-800">
      ...
      {/* --- Navigation --- */}
      <nav className={`fixed w-full z-40 transition-all duration-300 ${scrolled ? 'bg-navy-900 shadow-lg py-3' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <NavLink href="#about" onClick={() => setIsMobileMenuOpen(false)}>Über uns</NavLink>
              <NavLink href="#transport" onClick={() => setIsMobileMenuOpen(false)}>Transporte</NavLink>
              <NavLink href="#logistics" onClick={() => setIsMobileMenuOpen(false)}>Logistik</NavLink>
              <NavLink href="#moving" onClick={() => setIsMobileMenuOpen(false)}>Umzüge</NavLink>
              <Button 
                variant="primary" 
                size="sm" 
      ...
      <div className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight mb-6">
            Ihre Logistik. <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">Unsere Verantwortung.</span>
          </h1>
          <p className="text-xl text-gray-200 mb-10 max-w-2xl mx-auto font-light">
            Spezialisiert auf Transporte von 3,5 bis 20 Tonnen. Wir optimieren Ihre Lieferkette mit Präzision und deutscher Zuverlässigkeit.
          </p>
      ...
      <Section id="about">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h3 className="text-4xl font-extrabold text-navy-900 mb-6">Seit 2022 Ihr Partner für Effizienz.</h3>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              LogiTrans wurde mit einer klaren Vision gegründet: Transportdienstleistungen transparenter, schneller und zuverlässiger zu gestalten. Was mit einem einzelnen LKW begann, ist heute eine leistungsstarke Flotte, die täglich Waren quer durch Deutschland und Europa bewegt.
            </p>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Unser Fokus liegt auf dem Mittelstand. Wir verstehen, dass jede verspätete Lieferung Geld kostet. Deshalb setzen wir auf modernste Telematik, geschultes Personal und direkte Kommunikation.
            </p>
      ...
      <Section id="transport" className="bg-gray-100">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-signal-500 font-bold tracking-wider uppercase mb-2">Transportdienstleistungen</h2>
          <h3 className="text-4xl font-extrabold text-navy-900 mb-4">Sicher. Pünktlich. Individuell.</h3>
          <p className="text-gray-600">
            Ob Stückgut, Komplettladung oder Eiltransport – wir haben das passende Fahrzeug für Ihre Fracht von 3,5t bis 20t.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-t-4 border-transparent hover:border-signal-500 group">
      ...
      <Section id="why-us" dark>
        <div className="text-center mb-16">
          <h2 className="text-signal-500 font-bold tracking-wider uppercase mb-2">Warum LogiTrans?</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-300">Keine versteckten Kosten. Wir kommunizieren offen und proaktiv bei jedem Schritt.</p>
          </div>
          <div className="flex flex-col items-center text-center">
             <div className="bg-white/10 p-6 rounded-full mb-6 backdrop-blur-sm">
            ...
            <p className="text-gray-300">Kein Callcenter. Sie sprechen direkt mit Disponenten, die Ihr Geschäft verstehen.</p>
          </div>
          <div className="flex flex-col items-center text-center">
             <div className="bg-white/10 p-6 rounded-full mb-6 backdrop-blur-sm">
            ...
            <p className="text-gray-300">Geschultes Fahrpersonal, gesicherte Ladung und top-gewartete Fahrzeuge.</p>
          </div>
        </div>
      ...
      <Section id="logistics">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/2">
             <h2 className="text-signal-500 font-bold tracking-wider uppercase mb-2">Logistik-Outsourcing</h2>
             <h3 className="text-4xl font-extrabold text-navy-900 mb-6">Konzentrieren Sie sich auf Ihr Kerngeschäft.</h3>
             <p className="text-lg text-gray-600 mb-8">
               Lagerhaltung, Kommissionierung und Transportmanagement binden wertvolle Ressourcen. Wir übernehmen Ihre komplette Logistik – effizienter und oft kostengünstiger als eine interne Lösung.
             </p>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-8 relative">
              ...
              {[
                { title: "Analyse", desc: "Wir prüfen Ihre aktuellen Prozesse und Kostenstrukturen." },
                { title: "Konzept", desc: "Entwicklung einer maßgeschneiderten Outsourcing-Strategie." },
                { title: "Organisation", desc: "Übernahme der Logistikprozesse und Implementierung." },
          ...
          <div className="grid md:grid-cols-2">
            <div className="p-12 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-4">
                 ...
                 <span className="text-sm font-bold text-gray-500 uppercase tracking-wide">B2B & B2C</span>
              </div>
              <h3 className="text-3xl font-extrabold text-navy-900 mb-4">Umzüge in ganz Deutschland</h3>
              <p className="text-gray-600 mb-8">
                Ob Firmenumzug oder privater Wohnungswechsel – wir bringen Ihr Hab und Gut sicher ans Ziel. Inklusive Montage, Verpackung und Versicherung.
              </p>
              <Button onClick={() => openForm(FormType.MOVING)}>
                Individuelles Umzugsangebot
              </Button>
            </div>
            <div className="h-64 md:h-auto bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1600518464441-9154a4dea21b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80")' }}>
            </div>
          </div>
        </div>
      </Section>
      ...
      <footer className="bg-navy-900 text-white border-t border-navy-800">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 pt-20 pb-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            {/* Brand */}
            <div>
              <a href="#" className="text-2xl font-extrabold text-white tracking-tighter mb-6 block">
                LOGI<span className="text-signal-500">TRANS</span>
              </a>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li><a href="#about" className="hover:text-signal-500 transition-colors">Über uns</a></li>
                <li><a href="#transport" className="hover:text-signal-500 transition-colors">Transporte</a></li>
                <li><a href="#logistics" className="hover:text-signal-500 transition-colors">Logistik</a></li>
                <li><a href="#moving" className="hover:text-signal-500 transition-colors">Umzüge</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400 text-sm">
                <li className="flex items-start">
                  ...
                  <span>Logistikstraße 1<br/>10115 Berlin</span>
                </li>
                ...
                <li className="flex items-center">
                  <span className="w-4 h-4 mr-3 flex items-center justify-center text-signal-500 font-bold">@</span>
            ...
            <div className="bg-navy-800 p-6 rounded-lg">
              ...
              <p className="text-xs text-gray-400 mb-4">
                Wir wachsen weiter! Suchen aktuell:
              </p>
              <ul className="text-xs text-gray-300 space-y-2 mb-4">
                <li className="flex items-center"><ChevronRight size={12} className="text-signal-500 mr-1"/> LKW-Fahrer (CE)</li>
                <li className="flex items-center"><ChevronRight size={12} className="text-signal-500 mr-1"/> Disponenten</li>
              </ul>
              <a href="#" className="text-xs font-bold text-signal-500 hover:text-white transition-colors">
                Jetzt bewerben &rarr;
              </a>
            </div>
          </div>
